<template>
  <view class="fujin">
    ...
    <mescroll-uni style="width: 100%; height: 100%;" top="70" :fixed="true" :down="downOption" @down="downCallback" :up="upOption" @up="upCallback" @init="mescrollInit">
