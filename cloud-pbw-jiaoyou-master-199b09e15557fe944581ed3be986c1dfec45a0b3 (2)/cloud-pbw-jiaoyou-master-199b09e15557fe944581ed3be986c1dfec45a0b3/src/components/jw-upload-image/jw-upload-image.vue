<template>
  <view class="upload-content">
    ...
    <jw-modal ref="jwModal" title="提示" text="确定要放弃这张图片么" @onConfirm="delImage"></jw-modal>
  </view>
</template>
